<template>
  <div class="container">
    <form class="form card" @submit.prevent="handlerRegister">
      ...
      <div class="field">
        ...
        <input class="input" name="username" type="text" placeholder="Email" id="Email" />
      </div>
      <div class="field">
        <label for="username">Name</label>
        <input class="input" name="name" type="text" placeholder="name" id="username" />
      </div>
      <div class="field">
